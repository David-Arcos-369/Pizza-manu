...
const Header = ({name, basket}) => {
    ...
    return (
        <nav className="navbar navbar-light navbar-expand-md navigation-clean sticky-top">
            ...
            <div className="container"><a className="navbar-brand" href="/" alt="Home">{name}</a>
                ...
                <div className="collapse navbar-collapse" id="navcol-1">
                     <ul className="navbar-nav align-items-baseline ms-auto">
                        <li className="nav-item"><a className="nav-link fs-4 text-white" href="/" alt="deals">Deals</a></li>
                    </ul>
                    <ul>
